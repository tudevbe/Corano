                            ...
                            <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="text" id="sdt_nguoi_nhan" name="sdt_nguoi_nhan"
                                        placeholder="Email Address" value="{{ Auth::user()->phone }}" />
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan"
                                        placeholder="Email Address" value="{{ Auth::user()->address }}" />
                                ...
                                <div class="single-input-item">
                                    ...
                                    <textarea name="ghi_chu" id="ghi_chu" cols="30" rows="3" placeholder="Nhập ghi chú cho đơn hàng"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
