                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="mo_ta_ngan" id="mo_ta_ngan" class="form-control @error('mo_ta_ngan') is-invalid @enderror"
                                                placeholder="Mô tả ngắn" rows="3">{{ old('mo_ta_ngan') }}</textarea>
                                            @error('mo_ta_ngan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="hinh_anh_dm" src="" alt="Ảnh sản phẩm"
